...
baixar_video_por_link() {
    read -rp "🔗 Cole o link do vídeo: " url
    [[ -z "$url" ]] && return
...
menu() {
    while true; do
        ...
        opcao=$(printf "🚪 Sair\n❌ Remover música/vídeo\n📃 Listar vídeos\n📜 Listar músicas\n🎞️ Assistir vídeo\n🌐 Assistir online\n🔗 Baixar vídeo por link\n🎬 Baixar vídeo\n📂 Baixar playlist\n📥 Baixar música\n🎧 Ouvir música" | \
                fzf --prompt="🎛️ Menu: " --height=13 --no-header) || continue
        ...
        case "$opcao" in
            ...
            "🔗 Baixar vídeo por link") baixar_video_por_link ;;
